...
const WhyMeList: React.FC = () => {
  return (
    <div className='mb-32 max-w-6xl sm:mx-auto '>
      <ul className='flex flex-col lg:flex-row justify-evenly gap-16 text-gray-300'>
        <li>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
            fill='cyan'
            className='inline-block w-12 h-12 fill-current text-cyan'
          >
            <path d='M24 10.935v2.131l-8 3.947v-2.23l5.64-2.783-5.64-2.79v-2.223l8 3.948zm-16 3.848l-5.64-2.783 5.64-2.79v-2.223l-8 3.948v2.131l8 3.947v-2.23zm7.047-10.783h-2.078l-4.011 16h2.073l4.016-16z' />
          </svg>
          <h4 className='about-subtitle'>Self Taught</h4>
          <ul>
            <li>Curious</li>
            <li>Ressourceful</li>
        ...
        <li>
          ...
          <h4 className='about-subtitle'>Growth Mindset</h4>
          <ul>
        ...
        <li>
          ...
          <h4 className='about-subtitle'>Passionate</h4>
          <ul>
            <li>Coding</li>
            <li>Trail running</li>
            <li>Skiing</li>
