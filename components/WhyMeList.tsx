...
const WhyMeList: React.FC = () => {
  return (
    <div className='z-10 mb-32 max-w-6xl sm:mx-auto '>
      <ul className='flex flex-col items-center justify-evenly gap-16 text-gray-300 lg:flex-row '>
        <li className='w-64 rounded-xl bg-gray-700 bg-opacity-10 py-8 px-4 text-white shadow-lg backdrop-blur-xl'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
            fill='cyan'
            className='inline-block h-12 w-12 fill-current text-cyan'
          >
        ...
        <li className='w-64 rounded-xl bg-gray-700 bg-opacity-10 py-8 px-4 text-white shadow-lg backdrop-blur-xl'>
          ...
          <h3 className='about-subtitle'>Growth Mindset</h3>
          <ul>
            <li>Strive to improve</li>
        ...
        <li className='w-64 rounded-xl bg-gray-700 bg-opacity-10 py-8 px-4 text-white shadow-lg backdrop-blur-xl'>
          ...
          <h3 className='about-subtitle'>Passionate</h3>
          <ul>
            <li>Coding</li>
            <li>Trail running</li>
            <li>Skiing</li>
